...
def monopoly_with_fourth_tier
  ...
  monopoly[:railroads][:rent_in_dollars]
  monopoly[:railroads][:rent_in_dollars] = {:one_piece_owned => 25, :two_pieces_owned => 50, :three_pieces_owned => 100, :four_pieces_owned => 200}
  monopoly[:railroads][:names] = {:reading_railroad => {"mortgage_value" => "$100"}, :pennsylvania_railroad => {"mortgage_value" => "$200"}, :b_and_o_railroad => {"mortgage_value" => "$400"}, :shortline_railroad => {"mortgage_value" => "$800"}}
  # # monopoly[:railroads][:names][:reading_railroad][:mortgage_value]
  # # monopoly[:railroads][:names][:reading_railroad][:mortgage_value] = "$100"
  # monopoly[:railroads][:names][:reading_railroad]["mortgage_value"]
  # monopoly[:railroads][:names][:pennsylvania_railroad]["mortage_value"]
  # # monopoly[:railroads][:names][:pennsylvania_railroad]["mortage_value"] = "200"
  monopoly
end
